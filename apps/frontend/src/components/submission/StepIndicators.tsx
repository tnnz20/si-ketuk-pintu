        ...
        return (
          <div key={step.id} className="flex items-center">
            <button
              ...
              className={`flex items-center gap-2 rounded-full px-4 py-2 transition-all ${currentStep === step.id ? 'bg-emerald-600 text-white shadow-lg shadow-emerald-600/25' : completed ? 'bg-emerald-500/10 text-emerald-700 hover:bg-emerald-500/20' : 'bg-surface-container text-on-surface-variant'}`}
            >
