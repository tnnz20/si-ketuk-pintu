  ...
  return (
    <div className="mx-auto flex min-h-[60vh] max-w-xl flex-col items-center justify-center px-margin-mobile py-16 text-center">
      ...
      <p className="mt-4 font-body-md text-body-md text-on-surface-variant">
        No visitor request matches token <strong className="text-on-surface">{token || 'provided'}</strong>.
      </p>
      <div className="mt-8 flex flex-col gap-3 sm:flex-row">
        <Link to="/#status" className="flex items-center justify-center gap-2 rounded bg-primary px-6 py-3 font-label-md text-label-md text-on-primary">
