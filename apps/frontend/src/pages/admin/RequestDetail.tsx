              ...
              <section className="rounded-lg border border-surface-alt bg-surface-container-lowest p-6">
                ...
                {request.attachments.map((doc) => (
                  <button
                    ...
                    onClick={() => download(doc.attachment_type, doc.original_name)}
                    className="mb-3 flex w-full items-center justify-between rounded border border-surface-alt p-3 text-left hover:bg-surface-container"
                  >
